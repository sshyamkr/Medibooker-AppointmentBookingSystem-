...
import loginImage from "../assets/login.png"; // Correct the image import path
...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen" style={{ backgroundColor: "#63cfcd" }}>
      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-[#1a1f12] rounded-lg shadow-md flex flex-col justify-center">
        <h2 className="text-2xl font-bold text-center text-[#f1fddb]">Login</h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              className="group relative flex w-full justify-center py-2 px-4 border border-transparent text-sm font-semibold rounded-md text-[#080e01] bg-[#63cfcd] hover:bg-[#63cf70] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#bef96f]"
            >
              Login
            </button>
          </div>
        ...
        <div className="text-center">
          <p className="text-sm text-[#f1fddb]">
            Not a user?{" "}
            <Link to="/register" className="font-medium text-[#63cf70] hover:text-[#9ee054]">Register</Link>
          </p>
        </div>
      </div>
    </div>
